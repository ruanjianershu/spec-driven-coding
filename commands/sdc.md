...
Prefer the smallest correct public SDC capability. Stop instead of inventing shortcuts when discovery, decisions, knowledge sources, impact, traceability, or validation evidence is missing.
