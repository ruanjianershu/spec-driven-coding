...
- Evaluate `knowledge-candidates.md` and recommend which candidates should be promoted to `.sdc/knowledge/product/`, `.sdc/knowledge/technical/`, `.sdc/memory/`, `.sdc/decisions/`, `.sdc/standards/`, or `AGENTS.md`.
